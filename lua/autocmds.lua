...
-- Semantic visual spine: make Treesitter/LSP roles readable through shape, not
-- only through color. This lives in autocmds because init.lua applies the
-- colorscheme after plugin setup.
local function vega_apply_semantic_style()
  local groups = {
    ["@variable.parameter"] = { fg = "#78d6ff", italic = true },
    ["@parameter"] = { fg = "#78d6ff", italic = true },
    ["@variable.builtin"] = { fg = "#ffcc4d", italic = true },
    ["@function"] = { fg = "#f2f7ff", bold = true },
    ["@function.call"] = { fg = "#f2f7ff", bold = true },
    ["@function.builtin"] = { fg = "#78d6ff", bold = true },
    ["@method"] = { fg = "#f2f7ff", bold = true },
    ["@method.call"] = { fg = "#f2f7ff", bold = true },
    ["@type"] = { fg = "#b69cff", bold = true },
    ["@type.builtin"] = { fg = "#b69cff", italic = true },
    ["@keyword.conditional"] = { fg = "#ffcc4d", italic = true },
    ["@keyword.import"] = { fg = "#ffcc4d", italic = true },
    ["@keyword.return"] = { fg = "#ffcc4d", italic = true },
    ["@tag.attribute"] = { fg = "#38c7ff", italic = true },
    ...
    ["@lsp.type.defaultLibrary"] = { fg = "#78d6ff", italic = true },
...
aucmd({ "ColorScheme", "LspAttach", "BufEnter" }, {
  group = augroup("vega_semantic_style_spine"),
  callback = function()
    vim.schedule(vega_apply_semantic_style)
  end,
})
