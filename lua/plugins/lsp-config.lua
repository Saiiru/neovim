...
return {
  {
    ...
    dependencies = {
      ...
      { "hrsh7th/cmp-nvim-lsp", enabled = true }, -- fallback se Blink ausente
    },
    config = function()
      ...
      require("symbol-usage").setup({
        ...
        text_format = function(s)
          if s.references then local n = s.references; return string.format(" 󰌹 %s %s", n, n == 1 and "ref" or "refs") end
          return ""
        end,
      })
      ...
      local servers = {
        ...
        -- Java -> em lua/langs/java.lua via jdtls
      }
  ...
  { "aznhe21/actions-preview.nvim", event = "LspAttach", opts = { telescope = { sorting_strategy = "ascending", layout_strategy = "vertical", layout_config = { width = 0.6, height = 0.7, prompt_position = "top", preview_cutoff = 20, preview_height = function(_,_,max) return max - 15 end } } } },
