return {
  {
    ...
    keys = {
      {
        ...
        function()
          require("overseer").run_template {
            ...
            params = { task = "run", skip_tests = true, tool = "auto", where = "auto" },
          }
        end,
        desc = "Run (auto)",
      },
      {
        ...
        function()
          require("overseer").run_template {
            name = "Java: Auto (Gradle/Maven/Javac) [tmux/local]",
            params = { task = "build", skip_tests = true, tool = "auto", where = "auto" },
          }
        end,
        desc = "Build (auto)",
      },
      ...
      { "<leader>RB", "<cmd>OverseerBuild<cr>", desc = "Task: Build from templates" },
      {
        "<leader>Rr",
        function()
          pcall(require("overseer").run_last)
        end,
        desc = "Task: Run last",
      },
      {
        "<leader>Rs",
        function()
          pcall(require("overseer").stop_all)
        end,
        desc = "Task: Stop all",
      },
    },
    opts = {
      ...
      task_list = {
        ...
        max_height = 16,
        default_detail = 1,
        bindings = { q = "Close", ["<esc>"] = "Close" },
      },
      templates = { "builtin", "langs.runner.templates" },
      components = {
        "default",
