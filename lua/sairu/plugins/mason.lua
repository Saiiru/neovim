...
function M.config()
  ...
  require("mason-lspconfig").setup({
    ensure_installed = {
      -- Frontend
      "ts_ls", "eslint", "html", "cssls", "tailwindcss", "volar", "angularls", "lua_ls", 'quick_lint_js', 'gradle_ls',
        'groovyls',         'bashls',

      -- Backend
      "pyright", "jdtls", "intelephense", "clangd", "dockerls", "jsonls", "yamlls",
    },
  ...
  require("mason-tool-installer").setup({
    ensure_installed = {
      "prettier", "eslint_d", "black", "isort", "shellcheck", "shfmt", "stylua",'java-debug-adapter',
        'java-test',
    },
    auto_update = true,
  })
