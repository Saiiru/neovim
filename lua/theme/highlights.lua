...
function M.apply()
	...
	local groups = {
		...
		LspInlayHint = { fg = "#667D92", bg = p.bg1, italic = true },
		...
		NoiceCmdlinePopupBorder = { fg = p.blue, bg = p.bg1 },
		NoiceCmdlineIcon = { fg = p.cyan, bg = p.bg1, bold = true },
		NoiceCmdlineIconSearch = { fg = p.teal, bg = p.bg1, bold = true },
		NoiceCmdlinePrompt = { fg = p.blue, bg = p.bg1, bold = true },
		NoicePopupmenu = { fg = p.fg0, bg = p.bg1 },
		NoicePopupmenuBorder = { fg = p.border, bg = p.bg1 },
		NoicePopupmenuSelected = { fg = p.fg0, bg = p.bg3, bold = true },
		NoicePopupmenuMatch = { fg = p.cyan, bg = p.none, bold = true },
		NoiceLspFloat = { fg = p.fg0, bg = p.bg1 },
		NoiceLspBorder = { fg = p.border, bg = p.bg1 },
		NoiceMini = { fg = p.fg1, bg = p.bg1 },
		NoiceFormatProgressDone = { fg = p.green, bg = p.bg1 },
		NoiceFormatProgressTodo = { fg = p.muted, bg = p.bg1 },
