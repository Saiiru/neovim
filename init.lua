--neovim Declare the path where lazy will clone plugin code
...
-- Load the keymaps from the core/keymaps.lua file
require("core.keymaps")

-- Load the auto commands from the core/autocmds.lua file
